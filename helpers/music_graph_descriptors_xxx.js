...
const music_graph_descriptors = {
		...
		*/
		...
		['Electronic Music_supercluster'		,	['Breakbeat Dance_cluster','Four-to-the-floor Dance_cluster']], //'Rap_cluster'
		...
		['Metal_supergenre'					,	['Metalcore','Nu Metal','Rap Metal','Symphonic Metal','Gothic Metal','Black Metal','Stoner Metal','Sludge Metal','Death Metal','Grindcore','Doom Metal','Crossover Thrash','Extreme Metal','Speed Metal','Trash Metal','British Metal','Glam Metal','Hair Metal','Pop Metal','Power Metal','Progressive Metal','Classic Metal']],
		['Rock & Roll_supergenre'			,	['Garage Rock','Surf Rock','Rock & Roll','Rockabilly','Skiffle']],
		['Classic Rock_supergenre'			,	['Heartland Rock','Arena Rock','Southern Rock','Glam Rock','Progressive Rock','Hard Rock','Acid Rock','Psychedelic Rock','Psychedelic Pop','British Psychedelia','Folk-Rock','Beat Music']],
		['Punk Rock_supergenre'				,	['Anarcho-Punk','Psychobilly','Synth-Pop','New Wave','No Wave','Post-Punk','Punk Rock','Pub Rock','Proto-Punk']],
		['Alternative_supergenre'			,	['Post Rock','Post-Grunge','Britpop','Alt. Rock','Pop Punk','Math Rock','Rap Rock','Funk Metal','Grunge','Dream Pop','Shoegaze','Noise Rock']],
		['Hardcore Punk_supergenre'			,	['Metalcore','Post-Hardcore','Math Rock','Grindcore','Crossover Thrash','Hardcore Punk','Anarcho-Punk']],
		['Contemporary_supergenre'			,	['Indie','Freak Folk','Neo-Prog','Dance-Punk','Chillwave','Garage Punk','Garage Rock Revival','Post-Punk Revival','Emo Rock','Post-Britpop','Neo-Psychedelia','Contemporary Rock','90s Rock']],
		['Pop_supergenre'					,	['Electropop','Indie','Freak Folk','Chillwave','Electroclash','Post-Britpop','Britpop','Dance Pop','Dream Pop','Shoegaze','Disco Pop','Eurodisco','Synth-Pop','80s Rock','Soft Rock','Power Pop','Psychedelic Pop','Pop Rock','Baroque Pop','Songwriter','Country Pop','Brill Building Sound','Skiffle']],
		...
		['North American Folk_supergenre'	,	['Folk-Rock','Freak Folk','Traditional Folk','Americana','American Primitive Guitar','Country Folk','Neo-Traditional Folk','Songwriter','Traditional American Folk']],
		...
		['Country_supergenre'				,	['Alt. Country','Americana','Neo Traditional Country','Contemporary Country','Owtlaw Country','Country Pop','Country Rock','Nashville Sound','Bakersfield Sound','Bluegrass','Honky Tonk','Hillbilly']],
		['R&B_supergenre'					,	['Funktronica','Urban Soul','Neo Soul','Electrofunk','Deep Funk','Disco','Soul Blues','Smooth Soul','Disco','Classic Funk','P-Funk','Philadelphia Soul','Motown Sound','Southern Soul','Doo Wop','R&B']],
		['Blues_supergenre'					,	['Hill Country Blues','Soul Blues','Modern Electric Blues','Blues Rock','British Blues','Zydeco','Chicago Blues','Jump Blues','Texas Blues','Piano Blues','Vaudeville Blues','Country Blues','Delta Blues']],
		...
		['Jazz_supergenre'					,	['Third Stream','Contemporary Jazz','Electro Swing','Nordic Jazz','Nu Jazz','Future Jazz','Acid Jazz','Smooth Jazz','Jazz Rock','Fusion','Post-Bop','Free Jazz','Avant-Garde Jazz','Soul-Jazz','Jazz-Funk','Hard-Bop','Cool Jazz','Bebop','New Orleans Jazz Revival','Dixieland Revival','Modal Jazz','Latin-Jazz','Bossa Nova','Swing','Mainstream Jazz','Big Band','Chicago Jazz','New Orleans Jazz','Dixieland']],
		['Jamaican_supergenre'				,	['Reggaeton','Reggae Fusion','Ragga','Dancehall','Ska revival','UK Reggae','Dub','Roots Reggae','Rocksteady','Ska','Mento']],
		['Rap_supergenre'					,	['Glitch Hop','Urban Breaks','Trap','South Rap','East Coast','Gangsta','Reggaeton','Progressive Rap','Jazz-Rap','West Coast','Miami Bass','Bounce','Golden Age','Hardcore Rap','Electro','Old-School','Alt. Rap','Psychedelic Rap']],
		...
		// ['Progressive Rock XL'				,	['Symphonic Rock',...	]],
		// TODO: // 80s Rock //90s Rock
		// ['West Coast XL'					,	['Glitch Hop','Urban Breaks','Trap','South Rap','East Coast','Gangsta Rap','Reggaeton','Progressive Rap','Jazz-Rap','West Coast','Miami Bass','Bounce','Golden Age','Hardcore Rap','Electro','Old-School','Alt. Rap','Psychedelic Rap']],
		// ['East Coast XL'					,	['Glitch Hop','Urban Breaks','Trap','South Rap','East Coast','Gangsta Rap','Reggaeton','Progressive Rap','Jazz-Rap','West Coast','Miami Bass','Bounce','Golden Age','Hardcore Rap','Electro','Old-School','Alt. Rap','Psychedelic Rap']],
		// ['South Coast XL'					,	['Glitch Hop','Urban Breaks','Trap','South Rap','East Coast','Gangsta Rap','Reggaeton','Progressive Rap','Jazz-Rap','West Coast','Miami Bass','Bounce','Golden Age','Hardcore Rap','Electro','Old-School','Alt. Rap','Psychedelic Rap']],
		// TODO: Canterbury Scene,Avant-Prog,Progressive Folk,Progressive Metal
		style_cluster: [
		...
		['Progressive Rock XL'				,	['Symphonic Rock','Hard Prog','Eclectic Prog','Krautrock','Math Rock','Neo-Prog','Progressive Rock']],
		['Classic Rock XL'					,	['Arena Rock','Southern Rock','Hard Rock','90s Rock','Blues Rock','Acid Rock','Folk-Rock','Beat Music']],
		['Psy XL & Gaze'					,	['Dream Pop','Shoegaze','Dance-Punk','Acid Rock','Psychedelic Rock','Psychedelic Folk','Psychedelic Rap','British Psychedelia','Psychedelic Pop','Neo-Psychedelia']],
		['Punk XL'							,	['Proto-Punk','Punk Rock','Anarcho-Punk','Psychobilly','Pop Punk']],
		...
		['Vocal Pop'						,	['R&B','Doo Wop','Rockabilly','Brill Building Sound']],
		['Disco XL'							,	['Funktronica','Electrofunk','Disco','Eurodisco','Disco Pop']],
		['Urban'							,	['Urban Soul','Urban Breaks'		]],
		['Funk'								,	['Classic Funk','P-Funk','Deep Funk','Electrofunk']],
		['Soul'								,	['Philadelphia Soul','Motown Sound','Southern Soul']],
		['Deep Soul XL'						,	['Smooth Soul','Soul Blues','Southern Soul']],
		['Traditional Country'				,	['Neo Traditional Country','Nashville Sound','Bakersfield Sound','Bluegrass','Honky Tonk','Hillbilly']],
		...
		['Classic Jazz'						,	['New Orleans Jazz','Dixieland','Chicago Jazz','Mainstream Jazz','Swing','Big Band','New Orleans Jazz Revival','Dixieland Revival']],
		...
		['Traditional American Folk XL'		,	['American Primitive Guitar','Neo-Traditional Folk','Traditional American Folk']],
		...
		['Rock & Roll'						,	['Rockabilly','Surf Rock','Garage Rock','Beat Music','R&B','Skiffle','Hillbilly','Brill Building Sound','Psychobilly']],
		...
		['Garage Rock'						,	['Rock & Roll','Surf Rock','Psychedelic Rock','Acid Rock','Pub Rock','Proto-Punk','Garage Rock Revival','Post-Punk Revival','Garage Punk']],
		['Beat Music'						,	['Rock & Roll','Folk-Rock','Psychedelic Rock','Acid Rock','Pop Rock','Power Pop','Hard Rock','R&B']],
		['Psychedelic Rock'					,	['Progressive Rock','Psychedelic Folk','Acid Rock','Glam Rock','Garage Rock','Hard Rock','P-Funk','Classic Funk','Blues Rock','British Blues','Fusion','Neo-Psychedelia']],
		...
		['Grunge'							,	['Noise Rock','Post-Grunge','Alt. Rock','Punk Rock','Trash Metal']],
		['Rap Rock'							,	['Funk Metal','Nu Metal','Rap Metal','Hardcore Rap']],
		...
		['Garage Rock Revival'				,	['Post-Punk Revival','Dance-Punk','Post-Punk','Garage Rock','Garage Punk']],
		['Brill Building Sound'				,	['Pop Rock','Power Pop','Rock & Roll']],
		['Power Pop'						,	['Beat Music','Brill Building Sound','Pop Punk']],
		['Hillbilly'						,	['Rock & Roll','Rockabilly','Skiffle','Honky Tonk','Bluegrass']],
		['Honky Tonk'						,	['Hillbilly','Rockabilly','Skiffle','Owtlaw Country','Nashville Sound','Bakersfield Sound','Neo Traditional Country']],
		['Bakersfield Sound'				,	['Owtlaw Country','Honky Tonk']],
		['Country Rock'						,	['Folk-Rock','Southern Rock','Heartland Rock','Nashville Sound']],
		['Country Pop'						,	['Folk-Rock','Soft Rock','Nashville Sound']],
		['Owtlaw Country'					,	['Bakersfield Sound','Alt. Country'	]],
		...
		['Classical Music_supercluster'		,	['Heavy Music_supercluster','Pop & Rock Music_supercluster','Rythm Music_supercluster','Electronic Music_supercluster','Breakbeat Dance_supercluster','Four-to-the-floor Dance_supercluster']],
		['Classical'						,	['Industrial','Heavy Metal','Classic Rock','Rock','Punk','Pop','Country','Blues','Jazz','Jazz Vocal','Hip-Hop','Hardcore','Electronic','Techno','House','Trance','Folk-Rock','Alt. Rock']],
		['British Folk-Rock'				,	['Americana','Country_supergenre','Country','Country Rock','Country Folk','Heartland Rock','Sunshine Pop','Beat Music','Roots Rock']],
		['British Folk-Jazz'				,	['Americana','Country_supergenre','Country','Country Rock','Country Folk','Heartland Rock','Sunshine Pop','Beat Music','Roots Rock']],
		['Folk Baroque'						,	['Americana','Country_supergenre','Country','Country Rock','Country Folk','Heartland Rock','Sunshine Pop','Beat Music','Roots Rock']],
		['Grunge'							,	['Indie','Britpop','Funk Metal','Beat Music','Roots Rock','Glam Rock','Pop Metal','Glam Metal','Hair Metal']],
		['Post-Britpop'						,	['Garage Revival','Post-Punk Revival','Garage Punk']],
		['Garage Revival'					,	['Dream Pop','Shoegaze']],
		...
		['Future Jazz'						,	['Industrial','Heavy Metal','Classic Rock','Rock','Punk','Pop','Country','Blues']],
		['Jazz Vocal'						,	['Industrial','Heavy Metal','Classic Rock','Rock','Punk','Pop','Country','Blues']],
		['Traditional Pop'					,	['Electropop','Electronic','Electro','Psychedelic Rock','Psychedelic Folk','Progressive Rock']],
		['Electronic'						,	['Heavy Metal','Classic Rock','Punk','Country','Blues','Jazz Vocal']],
		['Stoner Rock'						,	['Pop Rock','Pop']]
		],
		...
		,'Free Improvisation','Jam','Comedy','Children\'s Music'
		]),
		/*
			-------------------------
		...
		*/
		...
		nodeImageLink: 'ngraph/html/images/Starv2.png',
		
		style_clusterSize: 20,
		style_clusterShape: 'star',
		style_clusterImageLink: 'ngraph/html/images/Star.png',
		
		style_supergenreSize: 15,
		style_supergenreShape: 'circle',
		style_supergenreImageLink: 'ngraph/html/images/Star.png',
		
		style_supergenre_clusterSize: 18,
		style_supergenre_clusterShape: 'circle',
		style_supergenre_clusterImageLink: 'ngraph/html/images/Star.png',
		
		style_supergenre_superclusterSize: 22,
		style_supergenre_superclusterShape: 'rect',
		style_supergenre_superclusterImageLink: 'ngraph/html/images/Star_color.png',
