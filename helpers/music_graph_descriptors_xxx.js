...
const music_graph_descriptors = {
		...
		*/
		...
		['Mainstream Pop'					,	['Urban Soul','Electropop','Dance Pop','Disco Pop','Hypersoul']],
		...
		['Heavy Prog'						,	['Fusion', 'Jazz-Rock','Symphonic Prog','Crossover Prog','Southern Rock','Heartland Rock','Soft Rock']],
		...
		'Música Popular Brasileira','Jam Band'
		]),
		/*
			-------------------------
