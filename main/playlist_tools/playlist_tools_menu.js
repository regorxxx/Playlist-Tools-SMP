...
var menu_properties = { // NOSONAR [global]
	...
	async: ['Async processing', JSON.stringify({ 'Check tags': true, 'Tagger': true, 'Pools': false, 'Search by distance': false, 'Remove duplicates': false, 'Import track list': false })],
