...
try {window.DefinePanel('Playlist Tools: Button', {author:'XXX', version: '3.0.0-beta13', features: {drag_n_drop: false}});} catch (e) {/* console.log('Playlist Tools Menu Button loaded.'); */} //May be loaded along other buttons
