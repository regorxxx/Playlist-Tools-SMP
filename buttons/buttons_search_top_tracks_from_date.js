...
addButton({
	topTracksDate: new themedButton({x: 0, y: 0, w: 133, h: 22}, (parent) => {return 'Top ' + parent.buttonsProperties.playlistLength[1] + ' Tracks ' + (parent.buttonsProperties.year[1] || (new Date().getFullYear() - 1))}, function (mask) {
		if (mask === MK_SHIFT) {
